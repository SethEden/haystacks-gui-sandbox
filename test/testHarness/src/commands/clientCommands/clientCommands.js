...
async function customEchoCommand(inputData, inputMetaData) {
  const functionName = customEchoCommand.name;
...
async function bossPanic(inputData, inputMetaData) {
  const functionName = bossPanic.name;
  await haystacksGui.consoleLog(namespacePrefix, functionName, msg.cBEGIN_Function);
  await haystacksGui.consoleLog(namespacePrefix, functionName, msg.cinputDataIs + inputData);
  await haystacksGui.consoleLog(namespacePrefix, functionName, msg.cinputMetaDataIs + inputMetaData);
  let stringLength = 0;
...
async function clientCommand01(inputData, inputMetaData) {
  const functionName = clientCommand01.name;
  await haystacksGui.consoleLog(namespacePrefix, functionName, msg.cBEGIN_Function);
  await haystacksGui.consoleLog(namespacePrefix, functionName, msg.cinputDataIs + inputData);
  await haystacksGui.consoleLog(namespacePrefix, functionName, msg.cinputMetaDataIs + inputMetaData);
...
async function clientCommand02(inputData, inputMetaData) {
  const functionName = clientCommand02.name;
  await haystacksGui.consoleLog(namespacePrefix, functionName, msg.cBEGIN_Function);
  await haystacksGui.consoleLog(namespacePrefix, functionName, msg.cinputDataIs + inputData);
  await haystacksGui.consoleLog(namespacePrefix, functionName, msg.cinputMetaDataIs + inputMetaData);
  let returnData= [true, false];
...
async function clientCommand03(inputData, inputMetaData) {
  const functionName = clientCommand03.name;
  await haystacksGui.consoleLog(namespacePrefix, functionName, msg.cBEGIN_Function);
  await haystacksGui.consoleLog(namespacePrefix, functionName, msg.cinputDataIs + inputData);
  await haystacksGui.consoleLog(namespacePrefix, functionName, msg.cinputMetaDataIs + inputMetaData);
  let returnData= [true, false];
...
async function clientCommand04(inputData, inputMetaData) {
  const functionName = clientCommand04.name;
  await haystacksGui.consoleLog(namespacePrefix, functionName, msg.cBEGIN_Function);
  await haystacksGui.consoleLog(namespacePrefix, functionName, msg.cinputDataIs + inputData);
  await haystacksGui.consoleLog(namespacePrefix, functionName, msg.cinputMetaDataIs + inputMetaData);
  let returnData= [true, false];
...
async function clientCommand05(inputData, inputMetaData) {
  const functionName = clientCommand05.name;
  await haystacksGui.consoleLog(namespacePrefix, functionName, msg.cBEGIN_Function);
  await haystacksGui.consoleLog(namespacePrefix, functionName, msg.cinputDataIs + inputData);
  await haystacksGui.consoleLog(namespacePrefix, functionName, msg.cinputMetaDataIs + inputMetaData);
  let returnData= [true, false];
...
async function clientCommand06(inputData, inputMetaData) {
  const functionName = clientCommand06.name;
  await haystacksGui.consoleLog(namespacePrefix, functionName, msg.cBEGIN_Function);
  await haystacksGui.consoleLog(namespacePrefix, functionName, msg.cinputDataIs + inputData);
  await haystacksGui.consoleLog(namespacePrefix, functionName, msg.cinputMetaDataIs + inputMetaData);
  let returnData= [true, false];
...
async function clientCommand07(inputData, inputMetaData) {
  const functionName = clientCommand07.name;
  await haystacksGui.consoleLog(namespacePrefix, functionName, msg.cBEGIN_Function);
  await haystacksGui.consoleLog(namespacePrefix, functionName, msg.cinputDataIs + inputData);
  await haystacksGui.consoleLog(namespacePrefix, functionName, msg.cinputMetaDataIs + inputMetaData);
  let returnData= [true, false];
...
async function clientCommand08(inputData, inputMetaData) {
  const functionName = clientCommand08.name;
  await haystacksGui.consoleLog(namespacePrefix, functionName, msg.cBEGIN_Function);
  await haystacksGui.consoleLog(namespacePrefix, functionName, msg.cinputDataIs + inputData);
  await haystacksGui.consoleLog(namespacePrefix, functionName, msg.cinputMetaDataIs + inputMetaData);
  let returnData= [true, false];
...
async function clientCommand09(inputData, inputMetaData) {
  const functionName = clientCommand09.name;
  await haystacksGui.consoleLog(namespacePrefix, functionName, msg.cBEGIN_Function);
  await haystacksGui.consoleLog(namespacePrefix, functionName, msg.cinputDataIs + inputData);
  await haystacksGui.consoleLog(namespacePrefix, functionName, msg.cinputMetaDataIs + inputMetaData);
  let returnData= [true, false];
...
async function clientCommand10(inputData, inputMetaData) {
  const functionName = clientCommand10.name;
  await haystacksGui.consoleLog(namespacePrefix, functionName, msg.cBEGIN_Function);
  await haystacksGui.consoleLog(namespacePrefix, functionName, msg.cinputDataIs + inputData);
  await haystacksGui.consoleLog(namespacePrefix, functionName, msg.cinputMetaDataIs + inputMetaData);
  let returnData= [true, false];
