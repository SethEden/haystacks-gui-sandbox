 ...
 * @module Contains all of the client defined business rules as a map between function names and function calls.
...
const initClientRulesLibrary = function() {
  const functionName = initClientRulesLibrary.name;
