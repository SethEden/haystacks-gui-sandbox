...
const commandsMetaData = [
  {[wrd.cName]: cmd.cprintDataHive, [sys.cFilePath]: filePath, [wrd.cthreadable]: false, [sys.ccommandsDependencies]: [], [sys.cbusinessRulesDependencies]: []},
  {[wrd.cName]: cmd.cprintDataHiveAttributes, [sys.cFilePath]: filePath, [wrd.cthreadable]: false, [sys.ccommandsDependencies]: [], [sys.cbusinessRulesDependencies]: []},
  {[wrd.cName]: cmd.cclearDataStorage, [sys.cFilePath]: filePath, [wrd.cthreadable]: false, [sys.ccommandsDependencies]: [], [sys.cbusinessRulesDependencies]: []},
  {[wrd.cName]: cmd.cchangeSetting, [sys.cFilePath]: filePath, [wrd.cthreadable]: false, [sys.ccommandsDependencies]: [], [sys.cbusinessRulesDependencies]: [
    biz.cgetWordsArrayFromString, biz.cgetNamespacedDataObject, biz.csetNamespacedDataObject
  ]}
];

/**
 * @function initDataDirectorate
 * @description Adds the dataDirectorate commands meta-data to the D-data structure commandsMetaData-framework data structure.
 ...
 * @date 2025/07/16
 */
async function initDataDirectorate() {
  const functionName = initDataDirectorate.name;
